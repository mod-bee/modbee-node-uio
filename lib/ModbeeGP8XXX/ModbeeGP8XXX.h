/*!
  ...
  */
  ...
  #ifndef _MODBEE_GP8XXX_H_
  #define _MODBEE_GP8XXX_H_
  ...
  class ModbeeGP8XXX_IIC: public ModbeeGP8XXX
  {
    public:
      ...
      /**
       * @brief ModbeeGP8XXX constructor
       * @param resolution resolution
       * @param deviceAddr I2C address
       * @param pWire I2C object
       */
      ModbeeGP8XXX_IIC(uint16_t resolution, uint8_t deviceAddr = DFGP8XXX_I2C_DEVICEADDR, TwoWire *pWire = &Wire)
  ...
  class ModbeeGP8503: public ModbeeGP8XXX_IIC
  {
    public:
      ModbeeGP8503(uint16_t resolution = RESOLUTION_12_BIT, uint8_t deviceAddr = DFGP8XXX_I2C_DEVICEADDR, TwoWire *pWire = &Wire)
        :ModbeeGP8XXX_IIC(resolution, deviceAddr, pWire){};
  };
  
  class ModbeeGP8211S: public ModbeeGP8XXX_IIC
  {
    public:
      ModbeeGP8211S(uint16_t resolution = RESOLUTION_15_BIT, uint8_t deviceAddr = DFGP8XXX_I2C_DEVICEADDR, TwoWire *pWire = &Wire)
        :ModbeeGP8XXX_IIC(resolution, deviceAddr, pWire){};
  };
  
  class ModbeeGP8512: public ModbeeGP8XXX_IIC
  {
    public:
      ModbeeGP8512(uint16_t resolution = RESOLUTION_15_BIT, uint8_t deviceAddr = DFGP8XXX_I2C_DEVICEADDR, TwoWire *pWire = &Wire)
        :ModbeeGP8XXX_IIC(resolution, deviceAddr, pWire){};
      void setDACOutVoltage(uint16_t voltage, uint8_t channel=0);
  };
  
  class ModbeeGP8413: public ModbeeGP8XXX_IIC
  {
    public:
      ModbeeGP8413(uint16_t resolution = RESOLUTION_15_BIT, uint8_t deviceAddr = DFGP8XXX_I2C_DEVICEADDR, TwoWire *pWire = &Wire)
        :ModbeeGP8XXX_IIC(resolution, deviceAddr, pWire){};
  };
  
  class ModbeeGP8302: public ModbeeGP8XXX_IIC
  {
    public:
      ModbeeGP8302(uint16_t resolution = RESOLUTION_12_BIT, uint8_t deviceAddr = DFGP8XXX_I2C_DEVICEADDR, TwoWire *pWire = &Wire)
        :ModbeeGP8XXX_IIC(resolution, deviceAddr, pWire){};
      void setDACOutElectricCurrent(uint16_t current){setDACOutVoltage(current);};
  };
  
  class ModbeeGP8403: public ModbeeGP8XXX_IIC
  {
    public:
      ModbeeGP8403(uint16_t resolution = RESOLUTION_12_BIT, uint8_t deviceAddr = DFGP8XXX_I2C_DEVICEADDR, TwoWire *pWire = &Wire)
        :ModbeeGP8XXX_IIC(resolution, deviceAddr, pWire){};
  };
   ...
   **************************************************************************/
  class ModbeeGP8XXX_PWM: public ModbeeGP8XXX
  {
    public:
      ModbeeGP8XXX_PWM(int pin0 = -1, int pin1 = -1)
  ...
  class ModbeeGP8501: public ModbeeGP8XXX_PWM
  {
    public:
      ModbeeGP8501(int pin0 = -1, int pin1 = -1):ModbeeGP8XXX_PWM(pin0,pin1){};
  };
  
  class ModbeeGP8101: public ModbeeGP8XXX_PWM
  {
    public:
      ModbeeGP8101(int pin0 = -1):ModbeeGP8XXX_PWM(pin0){};
  };
  
  class ModbeeGP8101S: public ModbeeGP8XXX_PWM
  {
    public:
      ModbeeGP8101S(int pin0 = -1):ModbeeGP8XXX_PWM(pin0){};
  };
